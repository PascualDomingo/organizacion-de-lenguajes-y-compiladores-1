...
especiales = (\\n)|(\\')|(\\’)|(\\\")|(\\\”)
conjunto = (([^~]|{especiales})"~"([^~]|{especiales}))|([^,](,([^,]|{especiales}))+)
espacio = \t|\f|" "|\r|\n
...
<YYINITIAL>  {especiales}   {System.out.println("especiales: "+yytext() ); return  new Symbol(sym.especiales,yycolumn,yyline,yytext());}
<YYINITIAL> {letra}     {System.out.println("letra: "+yytext() );   return new Symbol(sym.letra,yycolumn,yyline,yytext());}
<YYINITIAL> {digito}    {System.out.println("digito: "+yytext() );  return new Symbol(sym.digito,yycolumn,yyline,yytext());}
...
//"\""        {return new Symbol(sym.comDob,yycolumn,yyline,yytext());}  
//"#"         {return new Symbol(sym.numeral,yycolumn,yyline,yytext());} 
//"$"         {return new Symbol(sym.dolar,yycolumn,yyline,yytext());} 
//"%"         {return new Symbol(sym.porsentaje,yycolumn,yyline,yytext());} 
//"&"         {return new Symbol(sym.ampersand,yycolumn,yyline,yytext());} 
//"\'"        {return new Symbol(sym.comSim,yycolumn,yyline,yytext());} 
...
//"_"         {return new Symbol(sym.guinB,yycolumn,yyline,yytext());}
//"`"         {return new Symbol(sym.acentoG,yycolumn,yyline,yytext());}
...
<YYINITIAL> {conjunto}        {System.out.println("conjunto: "+yytext() ); return  new Symbol(sym.conjunto,yycolumn,yyline,yytext());}
